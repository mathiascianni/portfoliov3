...
const AboutContentSection = () => {
    ...
    return (
        <div className="bg-dark p-8 relative">
            <motion.div variants={fadeInUpContainer} whileInView={"visible"} initial="hidden" viewport={{ once: true }} >
                <motion.h2 className="text-7xl mb-16 font-title uppercase" variants={fadeInUpItem}>
                ...
                <motion.button variants={fadeInUpItem} className="bg-primary block px-8 py-4 rounded-sm hover:bg-white hover:text-primary transition-all text-xl">Descargá mi currículum</motion.button>

                <motion.img variants={rocketAnimation} src="media/rocket.png" alt="" className="absolute bottom-0 left-0 object-fit max-w-[300px]" />
            </motion.div>
        </div>
    )
}
